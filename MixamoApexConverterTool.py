...
class MixamoApexConverter(QtWidgets.QDialog):
    ...
    def addMotionClips(self):
        ...
        for rCount in range(rowCount):
            ...
            if(loopCount >0):
                ...
                params = {"cyclesafter" : loopCount, "locomotion" : 2, "locomotionjoint": "mixamorig1:Hips", "matchtranslation" : 1, "orientationmethod" : 1, "method" : 1}
    ...
    def createMotionClipSequence(self,input1,input2):
        ...
        params = {"locomotion" : 2, "locomotionjoint": "mixamorig1:Hips", "matchtranslation" : 1, "orientationmethod" : 1, "method" : 1}
